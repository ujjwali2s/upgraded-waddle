  ...
  try {
    ...
    return (
      <div className="flex flex-col items-center justify-center py-16 gap-4">
        <p className="text-destructive font-medium text-lg">Failed to load dashboard data</p>
        <p className="text-muted-foreground text-sm max-w-md text-center">
          There was an error connecting to the database. Please ensure your database is active and connection settings are correct.
        </p>
        <div className="bg-destructive/5 p-4 rounded-md border border-destructive/20 mt-4 max-w-2xl overflow-auto">
